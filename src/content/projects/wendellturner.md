...
## The problem
The broker needed more than a brochure site. He needed live MLS listings, landing pages that rank for dozens of local neighborhoods, and a way to capture and route inquiries automatically.
...
## Impact
The site is live and indexed, with all 188 pages discovered in Google Search Console, automated lead capture, and an IDX-to-HubSpot pipeline running on schedule. Real client work, in production.
